...
import {StaticDirectories} from '../../../../rest/index.js';
      ...
      for (const key in current) {
        if (Object.hasOwn(current, key)) {
          ...
          if (this.isStaticProperty(key) && typeof value === 'string') {
            const staticPath = StaticDirectories.STATIC_FILES_DIRECTORY;
            const uploadPath = StaticDirectories.STATIC_UPLOAD_DIRECTORY;
